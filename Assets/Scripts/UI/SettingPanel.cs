...
namespace UI
{
    public class SettingPanel : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject rawEnemyImageGameObject;
        ...
        private void Awake()
        {
            ...
            if (Game.EnemyImage != null) rawEnemyImage.texture = Game.EnemyImage;
        ...
        private void SetUserData()
        {
            ...
            {
                rawEnemyImageGameObject.Activate();
